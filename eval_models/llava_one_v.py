...
# build gpt class
class Llava_One_V:
    def __init__(self, pretrained="lmms-lab/llava-onevision-qwen2-0.5b-ov", model_name="llava_qwen", patience=1000000, sleep_time=0, d_type=torch.float16, max_tokens=4096, temperature=0.0):
